...
<body>
    <div class="container">
        ...
        <div class="left-panel">
            ...
            <form method="POST" action="combination2.php" id="salesForm">
                ...
                <button type="submit" style="width: 100%; padding: 10px; background-color: #28a745; color: white; border: none; border-radius: 5px; cursor: pointer; font-size: 16px;">Complete Sale</button>
            </form>
