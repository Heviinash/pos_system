...
if ($filter === 'day') {
    ...
    $query_sales_tax = "SELECT DATE_FORMAT(created_at, '%d %b') AS period, SUM(subtotal) AS total_sales, SUM(subtotal) * 0.06 AS tax 
                        FROM sales_payments 
                        GROUP BY DATE(created_at)";
    ...
    $query_sales_tax = "SELECT DATE_FORMAT(created_at, '%b') AS period, SUM(subtotal) AS total_sales, SUM(subtotal) * 0.06 AS tax 
                        FROM sales_payments 
                        GROUP BY DATE_FORMAT(created_at, '%Y-%m')";
    ...
    $query_sales_tax = "SELECT DATE_FORMAT(created_at, '%Y') AS period, SUM(subtotal) AS total_sales, SUM(subtotal) * 0.06 AS tax 
                        FROM sales_payments 
                        GROUP BY YEAR(created_at)";
