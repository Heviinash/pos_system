...
<div class="container">
    <form method="POST" action="trialpayment.php" id="salesForm">
    ...
    <script>
        ...
        function displayQuotation(products, services) {
            ...
            products.forEach(function(product) {
                ...
                const name = product.product_needed || "Unknown product";
            ...
            services.forEach(function(service) {
                // Use default values to prevent "undefined" errors
                const serviceId = service.service_id || "No service ID";
                const serviceName = service.service_needed || "Unknown service";
            ...
            // Update totals (implement `calculateTotals` to reflect total amounts)
            calculateTotals();
        }
